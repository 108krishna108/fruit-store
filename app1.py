...
def register():
    ...
    # return render_template('register.html')
      user_role = session.get('user_role', 'guest')  # Replace with your logic to fetch user role
      show_admin = (user_role == "admin")  # Only show the admin checkbox if the user is an admin
      ...
      return render_template('register.html', show_admin=show_admin)
